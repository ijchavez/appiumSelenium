...
public class AirbnbConstants {
    public static final String CHOOSE_AN_ACCOUNT = "Elige una cuenta";
    public static final String TO_CONTINUE_USING_AIRBNB = "para continuar usando Airbnb";
    public static final String ADD_ANOTHER_ACCOUNT = "Agregar otra cuenta";
